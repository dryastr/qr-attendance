    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            @if (auth()->user()->role->name == 'admin')
                ...
                <li class="sidebar-item has-sub {{ Request::is('tingkat-kelas*') ? 'active' : '' }}">
                    <a href="#" class='sidebar-link'>
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ Request::routeIs('tingkat-kelas.index') ? 'active' : '' }}">
                            <a href="{{ route('tingkat-kelas.index') }}" class="submenu-link">Daftar Tingkat Kelas</a>
                        </li>
                    </ul>
                </li>
